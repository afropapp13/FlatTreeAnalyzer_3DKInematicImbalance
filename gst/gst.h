...
// Tue May  6 14:15:39 2025 by ROOT version 6.28/12
// from TTree gst/GENIE Summary Event Tree
// found on file: ../../../BuildEventGenerators/jobcards/atmo/14_1000180400_CC_v3_6_0_AR23_20i_00_000.gst.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../../BuildEventGenerators/jobcards/atmo/14_1000180400_CC_v3_6_0_AR23_20i_00_000.gst.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../../BuildEventGenerators/jobcards/atmo/14_1000180400_CC_v3_6_0_AR23_20i_00_000.gst.root");
      }
