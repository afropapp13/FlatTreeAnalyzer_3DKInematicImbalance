...
void interaction_breakdown() {
	...
	PlotNames.push_back("TrueThetaNuPlot"); YAxisLabel.push_back("#frac{d#sigma}{d#theta_{#nu_{#mu}}} #left[10^{-38} #frac{cm^{2}}{deg Ar}#right]");	
	...
	for (int iPlot = 0; iPlot < NPlots; iPlot++) {
		...
		for (int iSample = 0; iSample < NSamples; iSample++) {	
		  ...
		  PlotCanvas->SaveAs("/exp/uboone/data/users/"+UserID+"/PeLEETuples_Atmospherics/dune_FlatTTreePlots/"+CanvasName+".pdf");
		  delete PlotCanvas;
